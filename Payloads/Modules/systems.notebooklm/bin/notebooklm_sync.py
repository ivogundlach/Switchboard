...
HOME = Path.home()
NOTES_DIR = os.path.expanduser(os.environ.get("NOTEBOOKLM_NOTES_DIR", str(HOME / "Files")))
IMPORT_DIR = os.path.join(NOTES_DIR, "Notebook LM Inbox")
SYNC_DIR = os.path.expanduser(os.environ.get("NOTEBOOKLM_SYNC_DIR", str(HOME / ".local/state/notebooklm-sync")))
